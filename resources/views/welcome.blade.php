...
<body>
    ...
    <section class="pricing">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <p>
                                    <a href="{{route('checkout.create', 'pro-student')}}" class="btn btn-master btn-primary w-100 mt-3">
                                        Take This Plan
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{route('checkout.create', 'beginner-student')}}" class="btn btn-master btn-secondary w-100 mt-3">
            ...
            <div class="row pb-70">
                <div class="col-lg-12 col-12 text-center">
                    <img src="{{asset('images/brand.png')}}" height="30" alt="">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/budi.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Mark
                                        </h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/susi.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Beatrice
                                        </h4>
